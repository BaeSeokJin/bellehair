package com.bsj.delight.common.exception;
...
@Component
@ControllerAdvice(basePackages = "com.bsj.delight") // com.bsj.delight 아래에 있는 모든 Controller 대상
public class ExceptionAdvice {

	Logger logger = LoggerFactory.getLogger(this.getClass());

	// 예외가 발생했음으로 응답상태 코드를 500번으로 지정
	// default 200
